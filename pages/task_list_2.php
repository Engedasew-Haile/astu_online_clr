...
*/
	...
	$sql = "select user_basic_info.name, user_details.acad_year, user_details.entry_year, 
			user_details.reason_4clr from user_basic_info inner join user_details on user_basic_info.id = user_details.id 
			where user_details.entry_year != '' order by user_basic_info.name ASC";
			$result = mysqli_query($conn, $sql);
    ...
    <div id="content">
	  ...
	  <div class="form-group">
					...
					<br>		
						...
						<select name="stud_dept" id="stud_dept" class="form-control" style="">
						<option value="0">---select student's department---</option>
