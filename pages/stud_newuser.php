...
*/	
	...
	//if (($user_role != "student") || ($user_role != "regi_assis") || ($user_role != "library" ))
	if ($user_role == '')
		{
			$error = true;
...
//	 $sql2 = "INSERT INTO user_details (id) 
...
//	mysqli_query($conn, $sql2);
	...
	$successmsg = "Successfully Registered! <a href='stud_newuser.php'>Click here to Home</a>";
    ...
    <ul>
      <li class="active"><a href="../index.php">Home</a>
		...
		?>
			...
			<li ><a href="stud_newuser.php">Adding New User</a>
		</li>
