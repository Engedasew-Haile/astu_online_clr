...
<div class="wrapper col1">
  <div id="header">
    ...
    <div class="fl_right">
      <ul>
        <li class="last"></li>
			<li><a id="slideit" href="ttps://www.google.com/search">Search</a></li> 
...
<div class="wrapper col2">
  <div id="topnav">
    <ul>
      ...
      <li class="active" ><a href="clr_status_4stud.php">Clearance Status</a>
	  
	  <ul >
            
          <li ><a href="#">WelCome, Student</a></li>
		  <li><a href="#">Mr. User Name</a></li>
		  <li><a href="#">Your Department is </a></li>
...
<div class="wrapper col4">
  <div id="container">
    <div id="content">
      <h1> Clearance Status, for Student's  </h1>
       ...
       <thead style="font-size:14px;">
          <tr>
            ...
            <th>Clearance_Reason</th>
			 <th>---Approval_Statues---</th> <!--it's indeicate which office hold. . .-->
			<th>Approved_Date/Time</th>
			<th>---Remark---</th>
          </tr>
        </thead>
        <tbody>
...
<!-- ####################################################################################################### -->
       ...
       <div id="comments" style="padding: 10px 200px;">
        <h2>Comments</h2>
      ...
      <h2 style="padding: 0px 200px;">Write A Comment</h2>
      <div id="respond" style="padding: 0px 200px;">
