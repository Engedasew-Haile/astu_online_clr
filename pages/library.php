...
session_start ();
if(!(isset($_SESSION['name']) and $_SESSION['user_role'] == "library"))
	{
      ...
      <li class="active"><a href="../index.php">Home</a>
	   ...
	   <?php
		...
		?>	
				...
				<li> <a href="library.php">WelCome, <?php echo $_SESSION ["name"];?> </a></li>
				<li> <a href ="library.php"> <?php echo $_SESSION['user_role']; ?></a></li>
	   ...
	   ?>
			...
			<li><a href="task_list_4stud_clr.php">Task List</a></li>
			<li ><a href="acad_staff_details.php">Acad Staff Details</a></li>
