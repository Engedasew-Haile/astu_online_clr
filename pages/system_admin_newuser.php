...
if (isset ($_POST['create_newuser']))
	...
	$cuserp_key = ($_POST['userp_key']);
		...
		$query_3 = "INSERT INTO user_basic_info (name, id, user_role, email, userp_key, cuserp_key, created_date) 
    ...
    <ul>
      <li class="active"><a href="../index.php">Home</a>
        ...
        <!--  <li class="last"><a href="#">Delete</a></li>	 -->
			...
			<li class="active"><a href="system_admin_newuser.php">Adding New User</a>
		</li>																	
    </ul>
  </div>
</div>
		...
		<div class="col-md-5 col-md-offset-3 well">
			<form role="form" action="" method="post" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						<input type="submit" name="create_newuser" value="Sign Up" class="btn btn-primary" />
