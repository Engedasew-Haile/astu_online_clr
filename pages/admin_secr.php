...
<?php  
session_start();  
if(!(isset($_SESSION['name']) and  $_SESSION['user_role']=="admin_secr"))
{  
...
VALUES 
('Abera Tdese', 'EMP/1201723', 'AdminStaff', 'abera@yahoo.com', '1234567', '1234567', NOW())"))
    ...
    <ul>
      <li class="active"><a href="../index.php">Home</a>
		...
		?>
			...
			<li><a href="staff_newuser.php">Adding New User</a>
		</li>
