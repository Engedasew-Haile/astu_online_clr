<?php  
session_start();  
if(!(isset($_SESSION['name']) and $_SESSION['user_role']=="term_staff"))
{  
...
<div class="wrapper col1">
  <div id="header">
    ...
    <div id="logo">
    <h3><a href="../index.html">Adama Science and Technology University</a></h3>
      <p>Adama, Ethiopia</p>
    </div>
  ...
  <div id="topnav">
    <ul>
      <li ><a href="../index.php">Home</a></li>
			<li><a href="clr_status_4termstaff.php">Clearance Status</a>
		</li>
			<li class="active"><a href="term_staff_detail.php">Staff Details</a>
			       <ul>     
    <?php
				if ( isset( $_SESSION[ 'name' ] ) ) {
					?>		
		<form  method="post" action="">
          <li><a href="#">WelCome Former Employee, <?php echo $_SESSION[ 'name' ];?></a></li>
			...
			<form role="form" action="" method="post" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						...
						<option value="0">Please, select your sex</option>
					...
					<div class="form-group">
						<label for="name">Choose your Section Department:</label>
						<select name="dept_name" id="dept_name" class="form-control">
						<option value="">select your . . . </option>
						<option value="finance">Finance & Acc. Dept.</option>
						<option value="HR_manager">HR Manager</option>	
						<option value="hr_officer">HR Officer</option>					
						<option value="gen_service_supervisor">Gen. Service Supervisor</option> 
						<option value="property_control">Property control</option> 					
						</select>				
						<span class="text-danger"><?php if (isset($dept_name_error)) echo $dept_name_error; ?></span>
					</div>
					
					<!--reason_4clr-->
					<div class="form-group">
						<option name="term_staff" value="Terminating Staff"></option> 					
						</select>					
					</div>
					
					<div class="form-group">
						<label for="name">Your Position:</label>
						<input type="text" name="staff_position" placeholder="Enter Your Leaving Position" required value="" class="form-control" />
						<span class="text-danger"><?php if (isset($staff_position_error)) echo $staff_position_error; ?></span>
					</div>
					<div class="form-group">
						<label for="name">Please comment on your reason for clearance:</label> <br>		
						 (only terminated staff).<br>
						<textarea name="staff_comment" rows="4" cols="40" placeholder="Please, what was your service complain?" value="reason_clr" id="reason_clr"></textarea>	
						<span class="text-danger"><?php if (isset($reason_clr_error)) echo $reason_clr_error; ?></span>
					</div>
					...
					<div class="form-group">
						<input type="submit" name="add_detail" value="Add a Details" class="btn btn-primary" />
