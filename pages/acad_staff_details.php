...
//	session_start ();
	if (count($_POST) > 0)
	{
		...
		{	
			...
			// for chk institution name
			if ($institution_name == '')
				{
					$error = true;					
					$institution_name_error = "Please select your institution name";
				}
		...
		$sql = "INSERT INTO user_details (institution_name, dept_name, staff_position)
  ...
  <div id="topnav">
    <ul>
      <li ><a href="../index.php">Home</a>
			...
			<li><a href="task_list_4stud_clr.php">Task List</a>
		</li>
			<li class="active"><a href="acad_staff_details.php">Acad Staff Details</a>
			 <ul>
       ...
       <!--   <li class="last"><a href="acad_staff_details.php">&nbsp | &nbsp Please add your detail</a></li> -->
        </ul>
		</li>
			...
			<form role="form" action="" method="post" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						<label for="name">Choose your institution:</label>
						<select name="institution_name" id="institution_name" class="form-control">
						<option value="">select your . . . </option>
						<option value="continuing_edu_office">Continuing Edu-Office</option>
					<!--	<option value="dept_head">Department </option>	 -->
					<!--	<option value="dept_store">Department Store</option>		-->
						<option value="library">Library</option> 
						<option value="school">School </option> 
						<option value="student_afters">Student Afters</option> 
						</select>				
						<span class="text-danger"><?php if (isset($institution_name_error)) echo $institution_name_error; ?></span>
					</div>
						...
						<option value="other_department">Other Departments</option> 
						</select>	
					<!--	<input type="text" name="dept_name" placeholder="Please agree . . ." required value="" class="form-control" />  -->
						<span class="text-danger"><?php if (isset($dept_name_error)) echo $dept_name_error; ?></span>
					</div>
										
					<div class="form-group">
						<label for="name"> and Specify your position:</label> 
